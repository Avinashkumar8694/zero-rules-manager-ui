...
@Component({
  selector: 'app-condition-editor-nested',
  template: ''
})
export class ConditionEditorNestedComponent {
  constructor(private fb: FormBuilder) {}

  addNestedGroup(parentGroup: AbstractControl | null, createGroup: () => FormGroup, createRule: () => FormGroup) {
  ...
  private getRules(group: AbstractControl): FormArray {
